...
const defaultMeta = {
  ...
  description: "Thermust - Smart Temperature Management",
  ...
  image: "https://thermust.com/assets/card-image.png",
  author: "Thermust.com",
};
...
const SeoHead = (props: SeoHeadProps) => {
  ...
  return (
    <>
      ...
      {/* Windows 8 app icon */}
      <meta name="msapplication-TileColor" content="#9EC1C5" />
      <meta
        name="msapplication-TileImage"
        content="/favicon/ms-icon-144x144.png"
      />
      {/* Accent color on supported browser */}
      <meta name="theme-color" content="#9EC1C5" />
      <meta
        name="viewport"
